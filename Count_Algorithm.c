...
int main() {
    count_words("output_text.txt", "count_node1.txt");
    //ingresa el nombre de archivo de entrada y como quiere que se 
    //llame el de salida(depende de cada nodo para distinguirlos)
    return 0;
}
