...
int main() {
    ...
    printf("Nodo 2 esperando fragmento en el puerto %d...\n", PORT);
    ...
    while (1) {
        ...
        FILE *fp = fopen("Fragmentos/fragmento2.txt", "wb");
        ...
        preprocess_file("Fragmentos/fragmento2.txt", "Preprocesados/fragmento_proc2.txt");
        count_words("Preprocesados/fragmento_proc2.txt", "Conteos/conteo2.txt");

        // === 3. Enviar archivo de conteo de vuelta al servidor ===
        fp = fopen("Conteos/conteo2.txt", "rb");
        ...
        close(client_sock);
        printf("Nodo 2 terminó procesamiento y espera nueva conexión.\n");
    }
